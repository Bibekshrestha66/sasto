...
const CATEGORIES_DATA = [
  ...
  },
  {
    ...
    slug: "agriculture",
    icon: "🌾",
    description: "Seeds, tools, livestock, and farm products",
    subcategories: [
      ...
      { name: "Agri Services", slug: "agri-services" },
    ],
  },
  {
    name: "Digital",
    ...
    subcategories: [
      ...
      { name: "E-Books & Media", slug: "ebooks-media" },
      { name: "Online Courses", slug: "online-courses-digital" },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { name: "Health Supplies", slug: "health-supplies" },
      { name: "Personal Care", slug: "personal-care" },
      { name: "Pharmacy Products", slug: "pharmacy-products" },
      { name: "Wellness Services", slug: "wellness-services" },
    ],
  },
  {
    name: "Rooms",
    ...
    subcategories: [
      { name: "Private Rooms", slug: "private-rooms" },
      { name: "Shared Rooms", slug: "shared-rooms" },
      { name: "PG / Hostels", slug: "pg-hostels" },
      { name: "Apartment Rooms", slug: "apartment-rooms" },
